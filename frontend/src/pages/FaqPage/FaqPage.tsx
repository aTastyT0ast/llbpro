    ...
    return (
        <div
            ...
            <Card className={"mb-4"}>
                ...
                <CardContent>
                    <p>A: The leaderboard only shows players who have competed in at least five tournaments and whose last tournament was no longer than a year ago.</p>
